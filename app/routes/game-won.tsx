  ...
  return (
    <main className="min-h-screen p-8 bg-gray-900">
      <div className="max-w-6xl mx-auto flex flex-col items-center justify-center min-h-[80vh]">
        <div className="bg-white rounded-3xl shadow-2xl p-12 border-4 border-green-100 text-center max-w-2xl w-full">
          <div className="mb-8">
          ...
          <div className="p-6 bg-gray-50 rounded-2xl mb-10">
            <div className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-1">Total Money Earned</div>
