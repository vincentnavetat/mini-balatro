...
describe("ThreeOfAKind", () => {
  ...
  describe("score", () => {
    it("should return (11 + 11 + 11 + 30) * 3 for three Aces", () => {
      const cards = [
        new Card("Heart", "Ace"),
        new Card("Diamond", "Ace"),
        new Card("Club", "Ace"),
      ...
      expect(threeOfAKind.score()).toBe(189); // (11 + 11 + 11 + 30) * 3
    });

    it("should return (5 + 5 + 5 + 30) * 3 for three 5s", () => {
      const cards = [
        new Card("Heart", "5"),
        new Card("Diamond", "5"),
        new Card("Club", "5"),
      ...
      expect(threeOfAKind.score()).toBe(135); // (5 + 5 + 5 + 30) * 3
    });
  });
